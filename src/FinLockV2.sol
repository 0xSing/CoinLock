...
import "./interfaces/IPinkLockV2.sol";
import "./interfaces/IUniswapV2Router02.sol";
import "./interfaces/IUniswapV2Pair.sol";
import "./interfaces/IUniswapV2Factory.sol";
import "./interfaces/FullMath.sol";

contract FinLock02 is IPinkLock {
    ...
    struct Lock {
        ...
        uint256 tgeBps;     // In bips. Is 0 for normal locks // min: 10 / 10000 = 0.1%
        uint256 cycle;      // Is 0 for normal locks
        uint256 cycleBps;   // In bips. Is 0 for normal locks // min: 10 / 10000 = 0.1%
        ...
        returns (uint256)
    {
        ...
        uint256 tgeReleaseAmount = FullMath.mulDiv(  //a * b / 10000
            userLock.amount,
            userLock.tgeBps,
            10_000
        );
        uint256 cycleReleaseAmount = FullMath.mulDiv(  // a * b / 10000
            userLock.amount,
            userLock.cycleBps,
            10_000
        );
